    ...
    <div class="order-card glass">
      ...
      <div class="order-grid">
        ...
        <div class="panel glass">
          ...
          <p>Промокод: ${order.promoCode || 'Немає'}</p>
...
function exportOrdersCsv() {
  const rows = [['ID', 'Дата', 'Статус', 'Імʼя', 'Телефон', 'Місто', 'Сума', 'Промокод']];
  getOrders().forEach(o => rows.push([o.id, o.createdAt, o.status, o.customer.name, o.customer.phone, o.customer.city, o.total, o.promoCode || '']));
  exportCsv('smartzone-orders.csv', rows);
  showToast('Експорт готовий', 'CSV файл замовлень завантажено.');
}
